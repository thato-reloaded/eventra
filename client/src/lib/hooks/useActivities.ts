import { keepPreviousData, QueryClient, useInfiniteQuery, useMutation, useQuery } from "@tanstack/react-query";
...
export const useActivities = (id?: string) => {
  ...
  const updateAttendance = useMutation({
    ...
    onMutate: async (activityId: string) => {
      ...
      queryClient.setQueryData<Activity>(['activties', activityId], oldActivity => {
